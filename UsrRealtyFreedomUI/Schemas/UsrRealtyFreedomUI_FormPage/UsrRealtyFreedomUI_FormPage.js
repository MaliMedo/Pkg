	...
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_dwra6al_caption)#",
					"visible": true,
					"clicked": {
		...
		handlers: /**SCHEMA_HANDLERS*/[
			...
			},
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.PDS_UsrType_jwghe6r;
					var typeId = "";
					if (typeObject) {
					...
					var offerTypeObject = await request.$context.PDS_UsrOfferType_9tun6iz;
					var offerTypeId = "";
					if (offerTypeObject) {
