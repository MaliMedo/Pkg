namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateAvgPriceProcessMethodsWrapper

	/// <exclude/>
	public class UsrCalculateAvgPriceProcessMethodsWrapper : ProcessModel
	{

		public UsrCalculateAvgPriceProcessMethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			var priceColumn = esq.AddColumn("UsrPrice");  // SELECT UsrPriceUSD as UsrPriceUSD, UsrArea as UsrArea FROM UsrRealtyFreedomUI WHERE ...
