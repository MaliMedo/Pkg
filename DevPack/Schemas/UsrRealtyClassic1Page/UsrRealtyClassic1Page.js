define("UsrRealtyClassic1Page", ["ServiceHelper"], function(ServiceHelper) {
	return {
		...
		diff: /**SCHEMA_DIFF*/[
			{
				"operation": "insert",
				"name": "UsrName2e7521ef-3125-4583-9c8a-59ea801f1923",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOAT34328f8f-1fce-41cc-83c9-5dd3ae1f1b55",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOAT2bcc1666-aef1-4042-bbfe-a585bd76a4cb",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUPf5e13645-51b5-4888-bdd1-500fef338d9f",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUPd2ba547a-016d-4d39-9750-6e3381d23705",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "STRING90117fbb-cce7-4158-8c2b-bad6f76f4024",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 2,
